...
public class ProcessSomeData {
	...
	public static void main(String[] args) throws IOException {
		...
		File cfolder = new File("E:/Documents/Phd/ASR_Java_Evaluation/java_calibData/");
		File[] fn_calibData = cfolder.listFiles();
		
		
		File pfolder = new File("E:/Documents/Phd/ASR_Java_Evaluation/Java_procData/");
		File[] fn_procData = pfolder.listFiles();
		
		//TODO change this back when finished processing
		for (int i = 129; i < fn_calibData.length-1; i++) { 
			...
			Path p = Paths.get("E:/Documents/Phd/ASR_Java_Evaluation/outdata/java/");
